function [V0,gc,gl,gk] = accelerator(beta,alpha,delta,zgrid,Nz,piz,lss,vss,Nk,kgrid)
    ...
    if mod(iter,10) == 1
        ...
        for i2 = 1:Nz
            ...
            for i1 = 1:Nk
                ...
                V1(i1,i2) = -value_function(gk(i1,i2),beta,alpha,delta,zgrid,piz,lss,kgrid,V0,i1,i2);

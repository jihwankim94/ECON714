...
doEHL=1; %if=0, AOB or Nash bargaining; 
...
DSHARE=0.6682; %replacement ratio
...
rpi=2.1; %Coefficient on inflation
...
%technology diffusion into government spending and other parameters of the model
...
sigmaL=1; %inverse labor supply elasticity
...
sig_muz=0.1362; %unit root neutral technollogy
...
rhozetac=0; %consumption preference

...
%    plot(time,model_resp_itech_baseline(reorderidx(plotindx),1:pnstep),'r-'); hold on
    plot(time,model_resp_itech_baseline(reorderidx(plotindx),1:pnstep),'k--'); hold on
    
    if plotindx==1,
%            legend_string={['VAR ',num2str(conflevel*100),'%'],'VAR Mean',' Nash'}; 
            legend_string={['VAR ',num2str(conflevel*100),'%'],'VAR Mean',' Nash(D/w=0.37)'}; 
    end
    hold off
...
%    plot(time,model_resp_ntech_baseline(reorderidx(plotindx),1:pnstep),'r-'); hold on
    plot(time,model_resp_ntech_baseline(reorderidx(plotindx),1:pnstep),'k--'); hold on
...
%    plot(time,model_resp_mon_baseline(reorderidx(plotindx),1:pnstep),'r-'); hold on
    plot(time,model_resp_mon_baseline(reorderidx(plotindx),1:pnstep),'k--'); hold on

...
thetaGAM=thetaG; %counteroffer cost
thetaD=thetaG; %unemployment benefits
...
%steady states specific to unemployment models
...
wp=varthetp-J;
w=doEHL*(varthet)+(1-doEHL)*(wp*(1-rho*betta)); 
D=DSHARE*w/nD;
...
%steady state variables for ys vector (F economy)
...
% saving steady state values that are used as params in static file
